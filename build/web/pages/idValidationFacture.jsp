          ...
          <div class="card">
               <div class="card-body">
                   <% if(request.getAttribute("id") != null) { %>
                    <h4 class="card-title">Identifier-vous en tant que chef facturation pour pouvoir valider la facture</h4>
                    <form class="forms-sample" action="idValidationFacture" method="POST">
