...
%>
        ...
        <div class="container text-center">
            ...
            <% if(request.getAttribute("factures") != null) {
                ...
                <div class="row">
                    ...
                    <div class="col" style="border: 1px solid rgb(00,00,00);">
                        <%=factures.get(i).getPrestation().getDuree() %> minutes
                    </div>
                    <div class="col" style="border: 1px solid rgb(00,00,00);">
        ...
        <p style="margin-left:15%; width:70%;"><h4>Total : <%=request.getAttribute("montantTotal") %> ariary</h4></p>
        <p style="margin-left:15%; width:70%;"><h4>En euro : <%=request.getAttribute("montantEuro") %> EUR</h4></p>
        <% if(escale.isEnd()==true) { %>
        <p>
            <a href="idValidationFacture?id=2">
